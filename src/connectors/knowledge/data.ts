...
export const reportFormats: Record<string, ReportFormat> = {
  ...
  "metricas": {
    name: "Reporte de Métricas / Funnel de Conversión",
    description: "Panorama de métricas del funnel de adquisición de Medicus. Cubre desde la landing de medicus.com.ar hasta el alta online en el portal, pasando por el cotizador web (arma-tu-plan) y el flujo de WhatsApp (Chengo).",
    instructions: [
      "CONTEXTO DEL FUNNEL:",
      "El funnel de adquisición de Medicus tiene 3 canales de entrada que convergen en 2 objetivos:",
      "",
      "CANALES DE ENTRADA:",
      "1. medicus.com.ar (landing institucional) → redirige a armatuplan.medicus.com.ar",
      "2. armatuplan.medicus.com.ar (cotizador web) → entrada directa o desde campañas de display/programmatic/Google Ads",
      "3. WhatsApp Flow ('Chengo') → formularios enviados por N8N a contactos, cotización por chat",
      "",
      "En mobile, arma-tu-plan ofrece la opción de derivar al flujo de WhatsApp (Chengo).",
      "",
      ...
      "  Paso 2 (cotizador__paso_2__view) → Selección de cartilla",
      "  Paso 3 (cotizador__paso_3__view) → Resultados/planes",
      "  Intención de alta (cotizador__intencion_de_alta) → Usuario quiere darse de alta",
      ...
      "  Envío formulario (flow_1_envio_formulario) → N8N envía el formulario al usuario",
      "  Datos titular (flow_2_datos_titular) → Usuario completa datos",
      "  Tipo cartilla (flow_5_tipo_cartilla) → Selección de cartilla",
      "  Selección plan (flow_10_seleccion_plan) → Elige un plan",
      ...
      "  Flujo completado individual (flow_14_flujo_completado_individual) → Cotización terminada",
      "  Flujo completado familiar (flow_14_flujo_completado_familiar) → Cotización terminada familiar",
      "  Derivado a asesor (Derivado a Asesor) → Edad > 64 años, se deriva",
      "",
      "CÓMO PRESENTAR LAS MÉTRICAS:",
      "1. Preguntar el rango de fechas si no se especifica (default: última semana, desde el lunes)",
      "2. Usar granularidad 'day' para rangos de 1-2 semanas, 'week' para rangos mayores",
      "3. Usar type 'unique' para el funnel web (usuarios únicos), type 'general' para WhatsApp (eventos totales)",
      "4. Presentar primero el funnel web con tabla día por día",
      "5. Luego el funnel de WhatsApp con desglose individual/familiar",
      "6. Calcular tasas de conversión entre pasos clave:",
      "   - Paso 1 → Paso 2 (formulario → cartilla)",
      "   - Paso 1 → Intención de alta (visitante → interesado)",
      "   - Intención de alta → Redirect portal (interesado → acción)",
      "   - Envío WhatsApp → Flujo completado (envío → conversión)",
      "7. Destacar anomalías: picos, caídas, días con 0 en algún paso",
      "8. Si se segmenta por referrer, agrupar en categorías:",
      "   - medicus.com.ar (landing institucional)",
      "   - Google orgánico (google.com)",
    ...
    mixpanelQueries: [
      ...
      "  - Derivado a Asesor",
      "",
      "SEGMENTACIÓN POR ORIGEN (opcional) — Usar 'on' parameter en paso 1:",
      "  - on: properties[\"referrer\"] → para ver de dónde viene el tráfico",
      "  - on: properties[\"device\"] → para ver desktop vs mobile",
    ],
    hubspotQueries: [
      "No se requieren queries de HubSpot para el reporte de métricas general.",
